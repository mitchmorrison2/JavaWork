				...
				for (int x = 0; x < 24; x++) {
					...
					while (true) {
						...
						int casePicked = input.nextInt();
							...
							if (selections[casePicked] != false) { //used double negatives because it would always default to true within the while(true)
								System.out.printf("\nThat case was already selected\n"); }
							else if (selections[casePicked]!= true) { //used double negatives because it would always default to true within the while(true)
